  ...
  <div class="px-4 md:px-8 lg:px-20 py-4 bg-slate-50">
    <div class="max-w-[1200px] mx-auto">
      ...
      <TimelineComponent v-for="(exp, index) in experience" :key="index" :isfirst="index === 0"
        ...
        :icon="exp.type === 'Internship' ? 'mdi-school' : exp.type === 'Employment' && exp.job_role.includes('Developer') ? 'mdi-laptop' : exp.type === 'Employment' && exp.job_role.includes('Research') ? 'mdi-chart-scatter-plot-hexbin'  : exp.type==='Employment' ? 'mdi-briefcase' : 'mdi-laptop-account'" :cred-link="exp.cred_link"
