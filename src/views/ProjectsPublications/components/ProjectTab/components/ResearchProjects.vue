            ...
            <div v-for="(project, index) in projects"
                ...
                <div class="flex items-stretch">
                    ...
                    <div class="w-[88%] pr-6">
                        ...
                        <div class="flex items-start gap-2 mb-2">
                            ...
                            <div class="text-gray-600" v-if="project.guide?.name">
                                ...
                                <SmartLink v-if="project.guide.institution"
                                    :text="project.guide.institution" />
                            </div>
                        </div>
                        ...
                        <p v-if="project.colaborators && project.colaborators.length"
                            ...
                            Colaborators:
                            <template
                                v-for="(colab, i) in project.colaborators.split(',')"
                                :key="colab">
                                <SmartLink :type="'Person'" :text="colab.trim()" />
                                <span
                                    v-if="i < project.colaborators.split(',').length - 1">
                                    ,
                                </span>
                            </template>
                        </p>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span
                                v-for="tag in Array.isArray(project.tech_stack)
                                    ? project.tech_stack
                    ...
                    <div class="w-[12%] flex items-center justify-center">
                        <img v-for="logo in project.logo"
                            :key="logo"
                            :src="getLogoPath(logo)"
                            :alt="logo"
                            :title="logo"
                            class="max-h-16 object-contain opacity-90" />
                    </div>
                ...
                <div class="flex justify-end items-center mt-4">
                    ...
                    <v-tooltip location="top">
                        <template #activator="{ props }">
                            <a v-bind="props"
                                v-if="project.cred_link?.report"
                                :href="project.cred_link.report"
                                target="_blank"
                    ...
                    <a v-if="project.cred_link?.researchgate"
                        :href="project.cred_link.researchgate"
                        target="_blank"
                        class="px-2 mx-1 icon-wrapper border border-[#1980e6] text-[#1980e6] w-10 h-10 rounded-full flex items-center justify-center shadow hover:bg-[#1980e6] hover:text-white transition">
                    ...
                    <a v-if="project.cred_link?.github"
                        :href="project.cred_link.github"
                        target="_blank"
